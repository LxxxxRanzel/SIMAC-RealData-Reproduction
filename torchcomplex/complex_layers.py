...
from torch.nn import Conv2d, Conv3d, Linear, BatchNorm1d, BatchNorm2d, BatchNorm3d, LayerNorm, Conv1d
from torch.nn import ConvTranspose2d
from .complex_functions import complex_relu, complex_max_pool2d, complex_avg_pool2d, complex_max_pool3d, complex_max_pool1d
...
class ComplexMaxPool1d(Module):
    ...
    def forward(self, input):
        return complex_max_pool1d(input,
